  ...
  if($result  -> num_rows >0)
  {
    while($row = $result -> fetch_assoc()){
      if($row["rolul"] == "teacher1"){
        ...
        "</td><td>" . "Profesor BD" . "<td> <a href = 'stergeUtilizator.php?rn=$row[id]'> Sterge Utilizator</td>" . "</tr>";
      }
      else if($row["rolul"] == "teacher2"){
        echo "<tr><td>" . $row["lastname"] ."</td><td>" . $row["firstname"] . "</td><td>" . $row["email"] .
        "</td><td>" . "Profesor RC" . "<td> <a href = 'stergeUtilizator.php?rn=$row[id]'> Sterge Utilizator</td>" . "</tr>";
      }
      else if($row["rolul"] == "teacher3"){
        echo "<tr><td>" . $row["lastname"] ."</td><td>" . $row["firstname"] . "</td><td>" . $row["email"] .
        "</td><td>" . "Profesor TW" . "<td> <a href = 'stergeUtilizator.php?rn=$row[id]'> Sterge Utilizator</td>" . "</tr>";
      }
      else if($row["rolul"] == "teacher4"){
        echo "<tr><td>" . $row["lastname"] ."</td><td>" . $row["firstname"] . "</td><td>" . $row["email"] .
        "</td><td>" . "Profesor in asteptare" . "<td> <a href = 'stergeUtilizator.php?rn=$row[id]'> Sterge Utilizator</td>" . "</tr>";
      }
      else{
        echo "<tr><td>" . $row["lastname"] ."</td><td>" . $row["firstname"] . "</td><td>" . $row["email"] .
        "</td><td>" . "Student" . "<td> <a href = 'stergeUtilizator.php?rn=$row[id]'> Sterge Utilizator</td>" . "</tr>";
      }
    }
    echo "</table>";
  }else {
