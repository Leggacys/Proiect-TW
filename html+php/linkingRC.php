<?php
    ...
    try{    
        ...
        $querySelect = "SELECT distinct u.nume as firstname, u.prenume as lastname, u.id_curs as curs, u.an as an, u.semian as semian, u.grupa as grupa  FROM studentiacceptare u WHERE id_stud='$id_utilizator' AND id_curs='2';";
        $result = $conn -> query($querySelect);
        $row = $result -> fetch_assoc();
        $nume=$row['firstname'];

        $querySelect2 = "SELECT distinct u.nume as firstname, u.prenume as lastname, u.id_curs as curs, u.an as an, u.semian as semian, u.grupa as grupa  FROM studenti u WHERE id_stud='$id_utilizator' AND id_curs='2';";
        ...
        if($nume==NULL) {
            ...
            header("Location: http://localhost/testingWeb/html+php/statisticaRC.php");
            exit();
            }
            else {
                //este neinscris si se inscrie
                header("Location: http://localhost/testingWeb/html+php/acceptareRC.php");  
                echo "da";
                exit();
            }
        }
