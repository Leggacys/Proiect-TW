...
try{    
  ...
  echo "\n\n\n\n";
     ...
     exit();
          ...
          $sql = "SELECT id_student, nume, prenume, prezente, nota1, nota2, nota3, (nota1+nota2+nota3)/3 as media, titlu_curs FROM medie_ascultari WHERE '$id_utilizator' = id_student AND titlu_curs='BD'; ";
