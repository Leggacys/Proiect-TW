<?php
    ...
    function fetch_data(){
        ...
        $sql = "SELECT u.id AS id, u.lastname AS lastname, u.firstname AS firstname, u.email AS email, n.valoare AS test1, n.valoare2 AS test2, n.valoare3 AS test3, (n.valoare + n.valoare2 + n.valoare3)/3 AS media  FROM users u JOIN note n ON u.id=n.id_stud WHERE u.rol='0' ORDER BY lastname ASC ;";
